...
func validate() -> void:
	...
	host_button.disabled = is_connecting or\
		not is_valid_port or\
		not is_valid_name
	join_button.disabled = is_connecting or\
		not is_valid_port or\
...
func _on_join_pressed() -> void:
	...
	var error := client_peer.create_client(ip_address, port_number)
